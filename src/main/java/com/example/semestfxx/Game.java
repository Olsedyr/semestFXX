...
public class Game {
    ...
    public void createRooms() {
        ...
        Item.ToggleItem soveværelseLampe, vindue, computer, køkkenlampe, tv, vandhane, badeværelseLys;
        ...
        komfur = new Item.ChoiceItem("I dit køkken er der også et komfur. Du kan vælge enten at varme kødet i ovnen, " +
                ...
                "Din kogeplade er en induktionskogeplade og den ved du er meget energieffektiv når den skal varmes op.",
                "komfur",3,
        ...
        bad = new Item.ChoiceItem("Der er en bruser og et badekar på dit badeværelse. Du kan enten tage et brusebad eller karbad bad her. " +
                "Du ved at i gennemsnit bruger et karbad 105 liter varmt vand pr. bad, mens et brusebad kun bruger 70 liter.",
                "bad",3,
        ...
        transport = new Item.ChoiceItem("Du kan tage til stranden ved at cykle eller tage bilen. Der er ikke så langt og det er godt vejr, dog er det lidt koldt. " +
                "Du vil dog komme til at skulle bruge meget mere benzin hvis du tager bilen.",
                "transport",3,
        ...
        npc = new Item.ChoiceItem("En pige ved navn Grett står der og ser ud til, at hun gerne vil vide, hvordan man hjælper klimakrisen.",
                "NPC",
                2,
                "Yo",
                "Yoo",
